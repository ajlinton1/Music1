...
namespace com.andrewlinton.music
{
    ...
    public partial class MusicEntities1 : DbContext
    {
        public MusicEntities1()
            : base("name=MusicEntities1")
        {
        }
        ...
        public virtual DbSet<GetRandomUploadedSongs> GetRandomUploadedSongs { get; set; }
        public virtual DbSet<GetSongPlayHistory> GetSongPlayHistory { get; set; }
        public virtual DbSet<MellowSongs> MellowSongs { get; set; }
        public virtual DbSet<MellowSongs1> MellowSongs1 { get; set; }
        public virtual DbSet<RandomSongs> RandomSongs { get; set; }
        public virtual DbSet<RecentSongs> RecentSongs { get; set; }
        public virtual DbSet<SongsV> SongsV { get; set; }
