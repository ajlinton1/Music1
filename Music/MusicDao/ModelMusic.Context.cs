...
namespace Music
{
    ...
    public partial class MusicEntities : DbContext
    {
        ...
        public DbSet<SONG_HISTORY> SONG_HISTORY { get; set; }
        public DbSet<SONG_RATED> SONG_RATED { get; set; }
        public DbSet<Sync> Syncs { get; set; }
        public DbSet<GetRandomUploadedSong> GetRandomUploadedSongs { get; set; }
        public DbSet<GetSongPlayHistory> GetSongPlayHistories { get; set; }
        public DbSet<MellowSong> MellowSongs { get; set; }
        public DbSet<MellowSongs1> MellowSongs1 { get; set; }
        public DbSet<RandomSong> RandomSongs { get; set; }
        public DbSet<RecentSong> RecentSongs { get; set; }
        public DbSet<SongsV> SongsVs { get; set; }
